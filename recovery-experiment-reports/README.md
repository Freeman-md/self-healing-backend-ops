...
- `canonical-recovery-suite-v1/validation/`: one repetition of every recovery-mode and fault-profile cell;
- `canonical-recovery-suite-v1/benchmark/`: five repetitions of every cell for the initial descriptive benchmark.
